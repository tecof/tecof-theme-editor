...
describe('compileStyles', () => {
  ...
  // Every Tailwind utility is emitted with the v4 important marker (`p-4!`)
  // so editor styles beat the classes components bake into their own markup.
  it('compiles base layer tokens to important-marked classes', () => {
  ...
  it('compiles entrance-animation tokens to tecof-anim classes (no important marker)', () => {
    // Custom (non-Tailwind) classes are exempt from the `!` marker — a literal
    // bang would break their selectors.
...
describe('getSafelist', () => {
  it('includes base and prefixed variants of emitted classes (important-marked)', () => {
