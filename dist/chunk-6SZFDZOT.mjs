...
import React__default__default, { createContext, memo, useContext, useState, useMemo, useLayoutEffect, useEffect } from 'react';
...
var TecofApiClient = class {
   ...
   */
  async createSharedComponent(name, type, props) {
    try {
      const res = await fetch(`${this.apiUrl}/api/store/shared-components`, {
        method: "POST",
        headers: this.headers,
   ...
   */
  async updateSharedComponent(id, name, type, props) {
    try {
...
//# sourceMappingURL=chunk-6SZFDZOT.mjs.map
//# sourceMappingURL=chunk-6SZFDZOT.mjs.map