import { useLanguages, useActiveLanguage, FieldLoading, LanguageTabBar, CmsBindingButton } from './chunk-CHDU3NV7.mjs';
import { MediaDrawer } from './chunk-GYBPP7DV.mjs';
import { useTecof } from './chunk-JQGJZ4SL.mjs';
...
import { Bold as Bold$1, Italic as Italic$1, Underline as Underline$1, Strikethrough, Code as Code$1, Heading2, Heading3, Heading4, List, ListOrdered, AlignLeft, AlignCenter, AlignRight, Quote, SquareCode, Minus, Link as Link$1, Image as Image$1, RemoveFormatting, Undo2, Redo2 } from 'lucide-react';
...
var EditorToolbar = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "tecof-editor-toolbar", children: [
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleBold().run(), isActive: editor.isActive("bold"), title: "Kal\u0131n", children: /* @__PURE__ */ jsx$1(Bold$1, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleItalic().run(), isActive: editor.isActive("italic"), title: "\u0130talik", children: /* @__PURE__ */ jsx$1(Italic$1, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleUnderline().run(), isActive: editor.isActive("underline"), title: "Alt\u0131 \xE7izili", children: /* @__PURE__ */ jsx$1(Underline$1, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleStrike().run(), isActive: editor.isActive("strike"), title: "\xDCst\xFC \xE7izili", children: /* @__PURE__ */ jsx$1(Strikethrough, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleCode().run(), isActive: editor.isActive("code"), title: "Sat\u0131r i\xE7i kod", children: /* @__PURE__ */ jsx$1(Code$1, { size: ICON }) }),
    /* @__PURE__ */ jsx$1("div", { className: "tecof-editor-divider" }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleHeading({ level: 2 }).run(), isActive: editor.isActive("heading", { level: 2 }), title: "Ba\u015Fl\u0131k 2", children: /* @__PURE__ */ jsx$1(Heading2, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleHeading({ level: 3 }).run(), isActive: editor.isActive("heading", { level: 3 }), title: "Ba\u015Fl\u0131k 3", children: /* @__PURE__ */ jsx$1(Heading3, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleHeading({ level: 4 }).run(), isActive: editor.isActive("heading", { level: 4 }), title: "Ba\u015Fl\u0131k 4", children: /* @__PURE__ */ jsx$1(Heading4, { size: ICON }) }),
    /* @__PURE__ */ jsx$1("div", { className: "tecof-editor-divider" }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleBulletList().run(), isActive: editor.isActive("bulletList"), title: "Madde i\u015Faretli liste", children: /* @__PURE__ */ jsx$1(List, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleOrderedList().run(), isActive: editor.isActive("orderedList"), title: "S\u0131ral\u0131 liste", children: /* @__PURE__ */ jsx$1(ListOrdered, { size: ICON }) }),
    /* @__PURE__ */ jsx$1("div", { className: "tecof-editor-divider" }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().setTextAlign("left").run(), isActive: editor.isActive({ textAlign: "left" }), title: "Sola hizala", children: /* @__PURE__ */ jsx$1(AlignLeft, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().setTextAlign("center").run(), isActive: editor.isActive({ textAlign: "center" }), title: "Ortala", children: /* @__PURE__ */ jsx$1(AlignCenter, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().setTextAlign("right").run(), isActive: editor.isActive({ textAlign: "right" }), title: "Sa\u011Fa hizala", children: /* @__PURE__ */ jsx$1(AlignRight, { size: ICON }) }),
    /* @__PURE__ */ jsx$1("div", { className: "tecof-editor-divider" }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleBlockquote().run(), isActive: editor.isActive("blockquote"), title: "Al\u0131nt\u0131", children: /* @__PURE__ */ jsx$1(Quote, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().toggleCodeBlock().run(), isActive: editor.isActive("codeBlock"), title: "Kod blo\u011Fu", children: /* @__PURE__ */ jsx$1(SquareCode, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().setHorizontalRule().run(), title: "Yatay \xE7izgi", children: /* @__PURE__ */ jsx$1(Minus, { size: ICON }) }),
    /* @__PURE__ */ jsx$1("div", { className: "tecof-editor-divider" }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: editLink, isActive: editor.isActive("link"), title: "Ba\u011Flant\u0131", children: /* @__PURE__ */ jsx$1(Link$1, { size: ICON }) }),
    onImageClick && /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: onImageClick, title: "G\xF6rsel ekle", children: /* @__PURE__ */ jsx$1(Image$1, { size: ICON }) }),
    ...
    /* @__PURE__ */ jsx$1("div", { className: "tecof-editor-divider" }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().unsetAllMarks().clearNodes().run(), title: "Bi\xE7imi temizle", children: /* @__PURE__ */ jsx$1(RemoveFormatting, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().undo().run(), title: "Geri al", children: /* @__PURE__ */ jsx$1(Undo2, { size: ICON }) }),
    /* @__PURE__ */ jsx$1(ToolbarBtn, { onClick: () => editor.chain().focus().redo().run(), title: "Yinele", children: /* @__PURE__ */ jsx$1(Redo2, { size: ICON }) })
  ] });
};
var TipTapInstance = ({
  content,
...
//# sourceMappingURL=EditorField.impl-L57K7TIH.mjs.map
//# sourceMappingURL=EditorField.impl-L57K7TIH.mjs.map