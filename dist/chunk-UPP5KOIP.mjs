  ...
  return /* @__PURE__ */ jsx(Drawer.Root, { open, onOpenChange: (o) => {
    ...
    /* @__PURE__ */ jsxs(Drawer.Content, { className: "tecof-upload-drawer-content", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "tecof-upload-drawer-inner", children: [
        ...
        extraTabs.length > 0 && /* @__PURE__ */ jsxs("div", { className: "tecof-media-tabs", role: "tablist", children: [
          /* @__PURE__ */ jsxs(
            "button",
            {
              type: "button",
        ...
        activeTab !== "library" ? /* @__PURE__ */ jsx("div", { className: "tecof-media-tab-panel", children: extraTabs.find((t) => t.id === activeTab)?.render() }) : /* @__PURE__ */ jsxs(Fragment, { children: [
