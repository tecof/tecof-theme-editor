...
var extensionList = require('@tiptap/extension-list');
...
var Bold__default = /*#__PURE__*/_interopDefault(Bold);
var Italic__default = /*#__PURE__*/_interopDefault(Italic);
var Strike__default = /*#__PURE__*/_interopDefault(Strike);
...
var LanguageTabBar = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { style: fieldStyles.tabBar, children: languages.map((code) => /* @__PURE__ */ jsxRuntime.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: "14px" }, children: getFlag(code) }),
...
var createLanguageField = (options = {}) => {
  ...
  return {
    type: "custom",
    label,
    render: ({ value, onChange, readOnly, field, name: name2, id }) => /* @__PURE__ */ jsxRuntime.jsx(
      LanguageField,
      {
        field,
        name: name2,
...
var createExtensions = () => [
  ...
  Strike__default.default,
  Underline__default.default,
  Heading__default.default.configure({ levels: [2, 3, 4] }),
  extensionList.BulletList,
  extensionList.OrderedList,
  extensionList.ListItem,
  extensionList.ListKeymap,
  ...
  Link__default.default.configure({ openOnClick: false, HTMLAttributes: { target: "_blank" } })
];
...
var EditorToolbar = ({ editor }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: editorFieldStyles.toolbar, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: editorFieldStyles.divider }),
    /* @__PURE__ */ jsxRuntime.jsx(ToolbarBtn, { onClick: () => editor.chain().focus().undo().run(), title: "Undo", children: "\u21A9" }),
    /* @__PURE__ */ jsxRuntime.jsx(ToolbarBtn, { onClick: () => editor.chain().focus().redo().run(), title: "Redo", children: "\u21AA" })
  ] });
};
var TipTapInstance = ({
  content,
  ...
  const lastExternalContent = React__default.useRef(content);
  React__default.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntime.jsx(EditorToolbar, { editor }),
...
var FilePond = class extends React__default__namespace.default.Component {
  constructor(props) {
    super(props);
...
function useStateMachine(initialState, machine) {
  return React__default__namespace.useReducer((state2, event) => {
...
function RemoveScrollSideCar(props) {
  ...
  var shouldCancel = React__default__namespace.useCallback(function(name2, delta, target, should) {
...
var FileItemRenderer = ({ file: file2, onRemove, cdnUrl }) => {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: s.fileItem, children: [
    isImage(file2.type) ? /* @__PURE__ */ jsxRuntime.jsx("img", { src: `${cdnUrl}/${file2.name}`, alt: file2.name, style: s.fileThumb }) : /* @__PURE__ */ jsxRuntime.jsx("div", { style: s.fileIcon, children: /* @__PURE__ */ jsxRuntime.jsx(Image2, { size: 20 }) }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: s.fileInfo, children: [
      /* @__PURE__ */ jsxRuntime.jsx("p", { style: s.fileName, children: file2.name }),
      /* @__PURE__ */ jsxRuntime.jsx("p", { style: s.fileType, children: file2.type?.toUpperCase() })
    ] }),
    onRemove && /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", style: s.removeBtn, onClick: onRemove, children: /* @__PURE__ */ jsxRuntime.jsx(X, { size: 16 }) })
  ] });
};
var UploadField = React__default.forwardRef(({
  value = [],
  onChange,
  allowMultiple = true,
  maxFiles = 10,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: s.container, ref, children: [
    value.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", flexDirection: "column", gap: "8px" }, children: value.map((file2, idx) => /* @__PURE__ */ jsxRuntime.jsx(
      FileItemRenderer,
      {
        file: file2,
        cdnUrl,
    ...
    !readOnly && canAddMore && !showPond && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: s.actionBtns, children: [
      /* @__PURE__ */ jsxRuntime.jsxs("button", { type: "button", style: s.btnSecondary, onClick: () => setDrawerOpen(true), children: [
        /* @__PURE__ */ jsxRuntime.jsx(FolderOpen, { size: 16 }),
        " Medya Se\xE7"
      ] }),
      /* @__PURE__ */ jsxRuntime.jsxs("button", { type: "button", style: s.btnSecondary, onClick: () => setShowPond(true), children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(Drawer.Root, { open: drawerOpen, onOpenChange: setDrawerOpen, children: /* @__PURE__ */ jsxRuntime.jsxs(Drawer.Portal, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(Drawer.Overlay, { style: s.drawerOverlay }),
      /* @__PURE__ */ jsxRuntime.jsxs(Drawer.Content, { style: s.drawerContent, children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: s.drawerHeader, children: [
          /* @__PURE__ */ jsxRuntime.jsx("h2", { style: s.drawerTitle, children: "Medya K\xFCt\xFCphanesi" }),
        ...
        loading ? /* @__PURE__ */ jsxRuntime.jsx("div", { style: { textAlign: "center", padding: "40px", color: "#a1a1aa" }, children: "Y\xFCkleniyor..." }) : /* @__PURE__ */ jsxRuntime.jsx("div", { style: s.galleryGrid, children: galleryFiles.map((file2) => {
          ...
          return /* @__PURE__ */ jsxRuntime.jsxs(
            "div",
            {
              ...
              children: [
                isImage(file2.type) ? /* @__PURE__ */ jsxRuntime.jsx("img", { src: `${cdnUrl}/${file2.name}`, alt: file2.name, style: s.galleryThumb }) : /* @__PURE__ */ jsxRuntime.jsx("div", { style: { ...s.galleryThumb, display: "flex", alignItems: "center", justifyContent: "center", background: "#f4f4f5" }, children: /* @__PURE__ */ jsxRuntime.jsx(Image2, { size: 24, color: "#a1a1aa" }) }),
                /* @__PURE__ */ jsxRuntime.jsx("p", { style: { ...s.fileName, fontSize: "11px", width: "100%", textAlign: "center" }, children: file2.name })
              ]
            },
            file2._id
          );
...
function Me({ children: e }) {
  return React__default__namespace.default.createElement("div", { style: Y.container }, e);
}
var Z = Me;
var $ = Z;
function Ee({ width: e, height: r, isEditorReady: n, loading: t, _ref: a, className: m, wrapperProps: E }) {
  return React__default__namespace.default.createElement("section", { style: { ...v.wrapper, width: e, height: r }, ...E }, !n && React__default__namespace.default.createElement($, null, t), React__default__namespace.default.createElement("div", { ref: a, style: { ...v.fullWidth, ...!n && v.hide }, className: m }));
}
var ee = Ee;
var H = React__default.memo(ee);
function Ce(e) {
  React__default.useEffect(e, []);
}
var k = Ce;
function he(e, r, n = true) {
  let t = React__default.useRef(true);
  React__default.useEffect(t.current || !n ? () => {
    t.current = false;
  } : e, r);
}
var l = he;
...
function Oe({ original: e, modified: r, language: n, originalLanguage: t, modifiedLanguage: a, originalModelPath: m, modifiedModelPath: E, keepCurrentOriginalModel: g = false, keepCurrentModifiedModel: N = false, theme: x = "light", loading: P = "Loading...", options: y = {}, height: V = "100%", width: z = "100%", className: F, wrapperProps: j = {}, beforeMount: A = D, onMount: q = D }) {
  let [M, O] = React__default.useState(false), [T, s3] = React__default.useState(true), u = React__default.useRef(null), c = React__default.useRef(null), w = React__default.useRef(null), d = React__default.useRef(q), o = React__default.useRef(A), b = React__default.useRef(false);
  k(() => {
    let i = loader.init();
  ...
  }, [n, r, a, e, t, m, E]), U = React__default.useCallback(() => {
  ...
  return React__default__namespace.default.createElement(H, { width: z, height: V, isEditorReady: M, loading: P, _ref: w, className: F, wrapperProps: j });
}
var ie = Oe;
React__default.memo(ie);
function He(e) {
  let r = React__default.useRef();
...
function Ve({ defaultValue: e, defaultLanguage: r, defaultPath: n, value: t, language: a, path: m, theme: E = "light", line: g, loading: N = "Loading...", options: x = {}, overrideServices: P = {}, saveViewState: y = true, keepCurrentModel: V = false, width: z = "100%", height: F = "100%", className: j, wrapperProps: A = {}, beforeMount: q = D, onMount: M = D, onChange: O, onValidate: T = D }) {
  let [s3, u] = React__default.useState(false), [c, w] = React__default.useState(true), d = React__default.useRef(null), o = React__default.useRef(null), b = React__default.useRef(null), L = React__default.useRef(M), U = React__default.useRef(q), I = React__default.useRef(), i = React__default.useRef(t), f = se(m), Q = React__default.useRef(false), B = React__default.useRef(false);
  k(() => {
    let p = loader.init();
  ...
  }, [s3]), React__default.useEffect(() => {
    !c && !s3 && X2();
  }, [c, s3, X2]), i.current = t, React__default.useEffect(() => {
    s3 && O && (I.current?.dispose(), I.current = o.current?.onDidChangeModelContent((p) => {
      B.current || O(o.current.getValue(), p);
    }));
  }, [s3, O]), React__default.useEffect(() => {
    if (s3) {
  ...
  return React__default__namespace.default.createElement(H, { width: z, height: F, isEditorReady: s3, loading: N, _ref: b, className: j, wrapperProps: A });
}
var fe = Ve;
...
var CodeEditorField = React__default.forwardRef(({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { ref, style: s2.container, children: /* @__PURE__ */ jsxRuntime.jsx(
    Ft,
    {
